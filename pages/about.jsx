export default function About() {
	return (
		<div className="mt-16">
			...
			<div className="text-white text-justify sm:w-8/12 mx-auto mt-8">
				...
				enthralling theme of "Evolution to the eternity”. From October 15 to 17
				2022,tech aesthete and aficionado will amass together to show the magic
				with their hats of thoughts. Many exquisite events and seminar will be
				organised in the fields of scientific research, coding, robotics, public
				speaking and quizzes. The flagship events include the Sci-Tech quiz: An
				insightful and riveting quiz on topics related to science and
				technology, Roboquiz: capability to imitate intelligent human behaviour,
				it's all about AI! and to incorporate that in human life is a speciality
				of robotics. Insight-out : - A fun event of 2 rounds where participants
				will act and write in accordance with the character assigned. Dev Hacks
				: to show off your dev skills to the world , beat the other teams and
				complete the tasks before the time is over. Apart from that, Pantheon
				'22 will offer a manifold of entertainment activities such as gaming
				events, debates, presentations etc, providing fun entertainment along
				with a phrenic podium for the victors.
			</div>
			...
			<div className="text-white text-justify sm:w-8/12 mx-auto my-8">
				...
				necessary, and more concretely "Evolution: to the Eternity" is the only
				way humanity will survive this expeditious ecumenical change.
				Pantheon'22 aims to celebrate the paramount of evolution in society,
				systems and a common life. The evolution of our psyche is illuminated by
				our individual vigils into the dark background of eternity.
			</div>
